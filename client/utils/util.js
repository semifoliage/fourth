...
var showSuccess2 = text => wx.showToast({
    title: text,
    icon: 'success',
    duration: 2000
})
...
module.exports = { formatTime, formatDate, formatAll, showBusy, showSuccess, showSuccess2, showModel, dateCalcul, todayDate, objectMerge}
